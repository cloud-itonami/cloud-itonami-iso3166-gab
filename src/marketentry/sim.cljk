...
(defn -main [& _]
  (let [db (store/seed-db)
        actor (op/build db)]
    (println "== engagement/intake eng-1 (GAB, clean) ==")
    ...
    (println "== jurisdiction/assess eng-4 (sets up ga-entity-missing) ==")
    ...
    (println "== filing/submit eng-4 (ga-entity-missing -> HARD hold) ==")
